## NExt distro i might use in new lap
...
- WIndow (yuck for a month maybe)
    why not like i wanna learn it with xfce

### old [winner:void]

- opensuse (out- not now)
    couldnt figure out this man what is this
...
- i3-wm : (i3-wm i3lock i3status dunst rofi xclip copyq picom)
-swaywm (mostly not): (swaylock i3status rofi-wayland brightnessctl mako slurp swaybg )
